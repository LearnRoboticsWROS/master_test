...
: ${AMENT_CURRENT_PREFIX:="/home/fra/master_ws_test/src/install/cobot_ik"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cobot_ik/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cobot_ik/environment/path.sh"
