...
: ${AMENT_CURRENT_PREFIX:="/home/fra/master_ws_test/src/install/six_arm_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/six_arm_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/six_arm_moveit_config/environment/path.sh"
