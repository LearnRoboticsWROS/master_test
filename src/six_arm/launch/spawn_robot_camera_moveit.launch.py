...
def generate_launch_description():
    ...
    robot_description_file = os.path.join(
        get_package_share_directory('six_arm'), 'urdf', 'cobot_camera.urdf.xacro'
    )
    joint_controllers_file = os.path.join(
        get_package_share_directory('six_arm'), 'config', 'trajectory_controllers.yaml'
    )
    ...
    world_file = os.path.join(
        get_package_share_directory('ind_environment'), 'worlds', 'pick_and_place_workplace_object.world'
    )
    ...
    moveit_config = (
        MoveItConfigsBuilder("custom_robot", package_name="cobot_camera_moveit_config")
        .robot_description(file_path="config/custom_robot_gazebo_moveit.urdf.xacro")
        .robot_description_semantic(file_path="config/custom_robot.srdf")
        .trajectory_execution(file_path="config/moveit_controllers.yaml")
        #to add robot description kinematics and planning scene monitor
